    ...
    <div class="listings-posted">
        @if($property->verification == 'pending')
            <div class="pending-verification">
                <p>Will Live in 2-3 Hours</p>                    
            </div>
        @elseif($property->verification == 'expired')
            <div class="pending-verification">
                <p>Expired Re-active again</p>
                <a href="#" class="btn btn-primary">Active Property</a>
            </div>
        @endif  
        <div class="link">            
                    ...
                    @if($property->verification ==  'approved')
                        <div class="avatar-stack">
                            <div class="avatar-wrapper">
                                ...
                                <div class="avatar-tooltip" style="bottom: 5px; left:110px;">Deactive Property</div>
                            </div>
                        </div> 
                        <div class="avatar-stack">
                            <div class="avatar-wrapper">
                ...
                @elseif($type === 'interested')
                    <div class="avatar-stack">
                        <div class="avatar-wrapper">
                            ...
                            <div class="avatar-tooltip" style="bottom: -3px; left:50px;">Delete</div>
                        </div>
                    </div> 
                @else    
                    <div class="avatar-stack">
