        ...
        <div class="container-fluid">                              
            <div id="accordionExample" class="accordion ">
                <div class="card">
                    <div id="headingOne" class="card-header bg-white shadow-sm border-0">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 data-toggle="collapse" data-target="#collapseOne" aria-controls="collapseOne" >City</h4>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="card">
                <div id="headingTwo" class="card-header bg-white shadow-sm border-0">
                    <div class="row">
                        <div class="col-md-8">
                            <h4 data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" >Area</h4>
                        </div>
                        <div class="col-md-4">
                            <form action="" method="get" >
                                <div class="row">
