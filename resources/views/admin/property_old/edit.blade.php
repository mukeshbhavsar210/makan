                                ...
                                <div class="row">
                                            ...
                                            <select name="saleType" id="saleType" class="form-control">
                                                @if ($saleTypes->isNotEmpty())
                                                    @foreach ($saleTypes as $value)
                                                        <option {{ ($value->sale_type_id == $value->id) ? 'selected' : ''}} value="{{ $value->id }}">{{ $value->name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>                            
                                        </div>
                                            ...
                                            <select name="category" id="category" class="form-control">
                                                @if ($categories->isNotEmpty())
                                                    @foreach ($categories as $value)
                                                        <option {{ ($value->category_id == $value->id) ? 'selected' : ''}} value="{{ $value->id }}">{{ $value->name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>                            
                                        </div>
                                            ...
                                            <select name="view" id="view" class="form-control">
                                                ...
                                                @if ($facings->isNotEmpty())
                                                    @foreach ($facings as $value)
                                                        <option {{ ($value->facing_id == $value->id) ? 'selected' : ''}} value="{{ $value->id }}">{{ $value->name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>                            
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $property->area}}" id="total_area" name="total_area" class="form-control">                            
                                        </div>
                                    </div> 
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <select name="builder" id="builder" class="form-control">                                                                  
                                        ...
                                        @if ($builders->isNotEmpty())
                                            @foreach ($builders as $value)
                                                <option {{ ($value->builder_id == $value->id) ? 'selected' : ''}} value="{{ $value->id }}">{{ $value->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>                            
                                </div>   
