                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Name" value="{{ $area->name }}">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="slug" id="slug" class="form-control" placeholder="Slug" value="{{ $area->slug }}">
                                <p></p>
                            </div>
                        </div>
                    </div>
