    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('areas.create') }}" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        <form action="" method="post" id="areaForm" name="areaForm">
                            ...
                            <select name="city" id="city" class="form-control">
                                ...
                                @if($cities->isNotEmpty())
                                    @foreach ($cities as $city)
                                        <option {{ ($area->city_id == 2 ? 'selected' : '')}} value="{{ $city->id }}">{{ $city->name }}</option>
                                    @endforeach
                                @endif
                            </select>
                            <p></p>                            
            ...
            <div class="pb-5 pt-3">
                ...
                <a href="{{ route('areas.create') }}" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
        </form>
    </div>
    <!-- /.card -->
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(response["status"] == true){
                        ...
                        window.location.href="{{ route('areas.create') }}"
