            ...
            <div class="elementor-widget-wrap elementor-element-populated">
                <div class="elementor-element elementor-element-71a93d58 elementor-widget elementor-widget-heading"
                    ...
                    <div class="elementor-widget-container">
                        <h2 class="elementor-heading-title elementor-size-default">Discover Latest
                            Properties</h2>
                    </div>
                </div>
                ...
                <div class="elementor-element elementor-element-4943001a elementor-widget elementor-widget-rhea-ultra-properties-widget-1"
                    ...
                    <div class="elementor-widget-container">
                        <section
                            class="rhea-ultra-properties-one-section rhea-ultra-tooltip rhea-toolip-light rhea-card-style-1">
                            <div class="rhea-ultra-properties-one-wrapper owl-carousel"
                                id="rhea-carousel-4943001a">
                                        ...
                                        <div class="rhea-ultra-property-card">
                                            <div class="rhea-ultra-card-thumb-wrapper">
                                                <div class="rhea-ultra-property-thumb">
                                                    <a class="{{ route('jobDetails', $featuredJob->id) }}">
                                                ...
                                                <a href="{{ route('jobDetails', $featuredJob->id) }}"><img class="img-fluid" src="img/property-1.jpg" alt=""></a>
                                               
                                                <a href="{{ route('jobDetails', $featuredJob->id) }}">{{ $featuredJob->title }}</a>
                                            ...
                                            <div class="rhea-ultra-card-detail-wrapper">
                                                ...
                                                <span class="rhea-ultra-property-types"><small><a href="">{{ $featuredJob->location }}</a></small></span>
                                                <div class="rhea-ultra-price-meta-box  ">
                                                    <div class="rh_prop_card__priceLabel_ultra">
                                                        <p class="rh_prop_card__price_ultra">
                                                            <span class="ere-price-display">{{ $featuredJob->jobType->name }}</span>
                                                            <span class="ere-price-slash">/</span> <span
                                                                class="ere-price-postfix">Monthly</span>
                                                        </p>
                                                    </div>
                                                ...
                                                <div class="rvr_card_info_wrap">
                                                    ...
                                                    <p class="added-date"><span class="added-title">Added:</span> June 10, 2022</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="rhea-nav-4943001a"
                            class="rhea-ultra-carousel-nav-center rhea-ultra-nav-box rhea-ultra-owl-nav owl-nav">
                            <div id="rhea-dots-4943001a" class="rhea-ultra-owl-dots owl-dots"></div>
                        </div>
                    </section>
