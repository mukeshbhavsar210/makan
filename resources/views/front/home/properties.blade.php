                                        ...
                                        <div class="rhea-ultra-property-card">
                                            <div class="rhea-ultra-card-thumb-wrapper">
                                                <div class="rhea-ultra-property-thumb">
                                                    ...
                                                    <a href="{{ route('propertyDetails', $value->id) }}"><img loading="lazy" decoding="async" width="488" height="326" class="attachment-property-thumb-image size-property-thumb-image wp-post-image"
                                                        alt=""  src="{{ asset('uploads/property/small/'.$propertyImage->image) }}" ></a>
                                                    @endif                                                    
                                                </div>
