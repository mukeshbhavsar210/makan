	...
	@if(Route::currentRouteName() === 'front.home') 
    	<nav class="navbar navbar-expand-lg shadow py-3">
			<div class="container">
				...
				@include('front.layouts.header.login_header')
			</div>
		</nav>
	@else    
		...
		<div class="strip">
			...
			@include('front.layouts.header.search_slide')
			@include('front.layouts.header.login_header')
...
<div class="container-fluid">  
	...
	@elseif(Route::currentRouteName() === 'properties.details') 
		@include('front.layouts.header.filters')
		<div class="container">
			<ul class="breadcrumb">
