			...
			<div class="site-footer-top">
				<div class="site-footer-logo-wrapper">
					<a title="RealHomes Ultra" href="https://ultra.realhomes.io">
						<img alt="RealHomes Ultra"
							src="https://ultra-realhomes.b-cdn.net/wp-content/themes/realhomes/assets/ultra/images/logo.png">
					</a>
				</div>
				<div class="site-footer-social-link"><a class="facebook"
						href="https://www.facebook.com/InspiryThemes/" target="_blank"><i
							class="fab fa-facebook "></i></a><a class="twitter"
						href="https://twitter.com/inspirythemes" target="_blank"><i
							class="fab fa-twitter "></i></a><a class="instagram"
						href="https://www.instagram.com/envato/" target="_blank"><i
							class="fab fa-instagram "></i></a><a class="youtube"
						href="https://www.youtube.com/user/Envato" target="_blank"><i
				...
				<div class="rh-footer-widgets columns-3">
					<section id="text-2" class="widget clearfix widget_text">
						<div class="textwidget">
							...
							<p>Effortlessly adapt to various property types and market demands with our
					...
					<section id="nav_menu-2" class="widget clearfix widget_nav_menu">
						<div class="menu-footer-widget-menu-container">
							<ul id="menu-footer-widget-menu" class="menu">
								<li id="menu-item-153"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-130 current_page_item menu-item-153 rh-active">
									<a href="https://ultra.realhomes.io/" aria-current="page">Home</a></li>
								<li id="menu-item-205"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-205">
									<a href="https://ultra.realhomes.io/properties-grid-fullwidth/">Properties
										Listing</a></li>
								<li id="menu-item-152"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-152">
									<a href="https://ultra.realhomes.io/blog/">Blog</a></li>
								<li id="menu-item-151"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-151">
									<a href="https://ultra.realhomes.io/contact/">Contact</a></li>
							</ul>
						</div>
					</section>
				</div>
				<div class="rh-footer-widgets columns-3">
					<section id="search-2" class="widget clearfix widget_search">
						<form role="search" method="get" id="searchform" class="searchform"
							action="https://ultra.realhomes.io/">
							<div>
			...
			<div class="site-footer-contacts-wrapper">
				<div class="site-footer-contacts">
					...
					<a class="rh-ultra-footer-number rh-ultra-user-whatsapp-footer" target="_blank"
						href="https://api.whatsapp.com/send?phone=1-800-555-4321">
