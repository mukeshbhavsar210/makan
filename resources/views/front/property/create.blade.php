        ...
        <div class="row">
            <div class="col-md-3 col-12">
                <div class="progress-left">
                    <div class="card-body">
                        <a href="{{ route('properties.index') }}" class="link">Back</a> 
                                ...
                                <div class="tab-content" id="pills-tabContent_2">
                                    <div class="tab-pane fade show active" id="pills-basic" role="tabpanel" aria-labelledby="pills-tab_01">
                                        ...
                                        <ul class="nav nav-pills property-types" id="pills-tab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link active" id="pills-tab_01" data-bs-toggle="pill" data-bs-target="#pills-basic_2" role="tab" aria-controls="pills-basic_2" aria-selected="true">Residential</a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link" id="pills-tab_02" data-bs-toggle="pill" data-bs-target="#pills-properties_2" role="tab" aria-controls="pills-properties_2" aria-selected="false">Commercial</a>
                                            </li>
                                        </ul>
