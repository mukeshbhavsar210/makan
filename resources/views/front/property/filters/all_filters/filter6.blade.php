<div class="rhea_prop_search__option rhea_prop_search__select rhea_min_baths_field rhea-ultra-field-separator" data-key-position="6" style="order: 6">
    <span class="rhea_prop_search__selectwrap ">
       <div class="dropdown bootstrap-select show-tick rhea_multi_select_picker bs3" style="width: 100%;">
          <select name="bathrooms" id="select-bathrooms-27a00c8" class="rhea_multi_select_picker show-tick" data-size="5.5" tabindex="-98">
          ...
          <button type="button" class="btn dropdown-toggle btn-default" data-toggle="dropdown" role="combobox" aria-owns="bs-select-4" aria-haspopup="listbox" aria-expanded="false" data-id="select-bathrooms-27a00c8" title="All Baths">
             <div class="filter-option">
                <div class="filter-option-inner">
                   <div class="filter-option-inner-inner">All Baths</div>
                </div>
             </div>
